...
If you do not want to do this and if you are on windows, you can simply go to dist/ folder and run the app.exe file. For Mac users you can download and run the myapp.dmg file in the same folder.
